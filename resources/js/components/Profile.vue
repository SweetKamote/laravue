        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card card-widget widget-user mt-5">
                    ...
                    <div class="widget-user-header text-white" style="background: url('./img/usercover.png');">
                            ...
                            <div class="tab-pane" id="settings">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" name="inputProfile" class="form-input"
                                                @change="updatePhoto">
                                        </div>
                                    </div>
                                    <div class="form-group">
        ...
        methods: {
            updatePhoto(e) {
                ...
                if (file['size'] < 2111775) {
                    ...
                    Swal.fire({
                        title: 'Oops....',
                        text: 'Your trying to upload a large file',
                        type: 'error'
                    });
                }
            },
